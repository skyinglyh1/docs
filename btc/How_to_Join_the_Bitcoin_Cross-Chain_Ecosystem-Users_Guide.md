...
Please refer to this [guide](https://github.com/polynetworks/docs/blob/master/btc/cross-chain_transaction_construction_tool_user_manual.md) for detailed instructions on how to use the tool send a transaction. After sending the transaction, use an [Ethereum explorer](https://ropsten.etherscan.io/) to confirm the amount of BTC tokens sent to the contract address specified in the transaction.

#### 2. BTC transferred back to the Bitcoin network

Please refer to [this](https://github.com/polynetworks/docs/blob/master/eth/how_to_cross_on_ethereum.md) document for details.
